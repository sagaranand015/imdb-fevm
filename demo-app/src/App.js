...
function App() {
    ...
    async function getAvgRating(movieNum) {

        // let val = prompt("Give your rating from 1 to 10");
        console.log("get avg rating val:", movieNum);
                    ...
                    <Card key={mov.id} style={{width: '18rem'}}>
                        ...
                        <Card.Body>
                            ...
                            <ButtonGroup className="me-2" aria-label="First group">
                                <Button variant="success" onClick={() => rateMovie(mov.id, movieRating)}>Rate This
                                    Movie</Button>
                            </ButtonGroup>
                            <br/>
                            <Rating
                            ...
                            <ButtonGroup className="me-2" aria-label="second group">
                                <Button variant="primary" onClick={() => getAvgRating(mov.id)}>See Average
                                    Rating</Button>
                            </ButtonGroup>
                            {true ? <Rating
                                name="simple-controlled"
